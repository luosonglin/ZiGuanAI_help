...
![添加分派对象](https://cdn.songlin.site/工作/资管项目/xxx.png)

4.  点击「添加截止时间」，设置任务的最晚完成节点；同时可通过下拉菜单调整任务优先级（一般/紧急/重要），并可点击督办图标标记为督办任务
...
![添加附件/关联文件](https://cdn.songlin.site/工作/资管项目/xxx.png)

7.  核对全部信息无误后，点击右下角【创建】按钮完成任务发布；编辑已有任务时，修改信息后点击保存即可生效
![点击创建完成任务](https://cdn.songlin.site/工作/资管项目/xxx.png)
